...
var eventDesc = ["Purrfect day if you ask us!","Halloween night draws thousands of people in costume walking through Wakiki.","The Eddie is the biggest surfing event the world, only held when the surf height in the North Shore reaches 20ft.","Spam Jam is a food festival in Waikiki celebrates everyones favorite canned meat SPAM® "]
